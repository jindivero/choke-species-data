...
setwd(basewd)
#Location data
loc <- read_excel("data/oxygen options/hake/CTD-Location-Files/201103_ctd_locs.xlsx")
#All the CTD files
setwd("data/oxygen options/hake/CTD-data/2011-Hake")
all_files <- list.files(pattern=".csv", recursive=T)
dats_2011 <- list()
for(i in 1:length(all_files)){
...
#2012
setwd(basewd)
loc <- read_excel("data/oxygen options/hake/CTD-Location-Files/201204_ctd_locs.xlsx")
setwd("data/oxygen options/hake/CTD-data/2012-Hake")
all_files <- list.files(pattern=".csv", recursive=T)
dats_2012 <- list()
for(i in 1:length(all_files)){
  dat <- read.csv(all_files[i])
...
#2013
setwd(basewd)
loc <- read_excel("data/oxygen options/hake/CTD-Location-Files/201305_ctd_locs.xlsx")
setwd("data/oxygen options/hake/CTD-data/2013-Hake")
all_files <- list.files(pattern=".csv", recursive=T)
dats_2013 <- list()
for(i in 1:length(all_files)){
  dat <- read.csv(all_files[i])
...
#2015
setwd(basewd)
loc <- read_excel("data/oxygen options/hake/CTD-Location-Files/201507_ctd_locs.xlsx")
setwd("data/oxygen options/hake/CTD-data/2015-Hake")
all_files <- list.files(pattern=".csv", recursive=T)
dats_2015 <- list()
for(i in 1:length(all_files)){
  dat <- read.csv(all_files[i])
...
#Deepest depth
hake <- hake %>% group_by(longitude, latitude, date) %>%
  filter(depth == max(depth)) %>%
  ungroup() 
